...
MODELS = {
    "T92": {
        "type": "Таунхаус", "area": "92 м²", "parcel": "до 2 соток", "bedrooms": "3", "price": "від $85 000",
        ...
        "rooms": [[("Тамбур", "3,8 м²"), ("Кухня-вітальня", "28,7 м²"), ("Кабінет / спальня", "10,4 м²"), ("Санвузол", "4,2 м²"), ("Тераса", "16 м²")], [("Хол", "6,1 м²"), ("Спальня 01", "12,8 м²"), ("Спальня 02", "11,7 м²"), ("Спальня 03", "14,2 м²"), ("Ванна кімната", "5,4 м²")]],
    },
    "T102": {
        "type": "Таунхаус", "area": "102 м²", "parcel": "до 2 соток", "bedrooms": "3", "price": "за запитом",
        ...
        "rooms": [[("Тамбур", "4,1 м²"), ("Кухня-вітальня", "31,2 м²"), ("Кабінет", "10,8 м²"), ("Санвузол", "4,5 м²"), ("Тераса", "18 м²")], [("Хол", "6,8 м²"), ("Спальня 01", "13,5 м²"), ("Спальня 02", "12,1 м²"), ("Спальня 03", "14,8 м²"), ("Ванна кімната", "5,8 м²")]],
    },
    "D101": {
        "type": "Дуплекс", "area": "101 м²", "parcel": "до 2 соток", "bedrooms": "4", "price": "за запитом",
        ...
        "rooms": [[("Тамбур", "3,9 м²"), ("Кухня-вітальня", "26,7 м²"), ("Гостьова спальня", "11,2 м²"), ("Санвузол", "4,4 м²"), ("Тераса", "17 м²")], [("Хол", "6,5 м²"), ("Спальня 01", "12,6 м²"), ("Спальня 02", "11,9 м²"), ("Спальня 03", "13,8 м²"), ("Ванна кімната", "5,6 м²")]],
    },
}
